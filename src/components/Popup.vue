  ...
  <div class="popup">
    <form class="popup__form" @submit.prevent="save">
      ...
      <div class="popup__form__part">
        ...
        <input type="text" id="title" class="popup__form__input" v-model="title" />
      </div>
      ...
      <div class="popup__form__part">
        ...
        <input type="text" id="description" class="popup__form__input" v-model="description" />
      </div>
      ...
      <div class="popup__form__part">
        ...
        <span class="popup__form__text">{{$moment(start).format("DD.MM.YYYY")}}</span>
      </div>
      ...
      <div class="popup__form__part">
        ...
        <input type="date" id="ends" class="popup__form__input" v-model="ending" />
      </div>
      ...
      <div class="popup__form__buttons">
        <button @click="$emit('close')" class="popup__form__buttons__button">Cancel</button>

        <button class="popup__form__buttons__button save" type="submit">Save</button>
      </div>
    </form>
  </div>
</template>
